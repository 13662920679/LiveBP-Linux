...
public class UserController{
	...
	public void saveUser(HttpServletResponse response,HttpServletRequest request) throws IOException {
		...
		if(addUser>0) {
			...
			response.sendRedirect("http://193.112.192.103/:8080/LiveBP/login.html");
		}else {
			response.sendRedirect("http://193.112.192.103:8080/LiveBP/reg.html");
		}
...
//		response.setCharacterEncoding("text/html;charset=utf-8");
		...
		File file = new File("/touxiang/"+findTouxiang);
